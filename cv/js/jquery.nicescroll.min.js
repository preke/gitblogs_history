...
var g=!1
if(!v.opt.boxzoom||v.ispage||x.isieold||(g=document.createElement("div"),v.bind(g,"click",v.doZoom),v.zoom=a(g),v.zoom.css({cursor:"pointer","z-index":v.zindex,backgroundImage:"url("+v.opt.scriptpath+"zoomico.png)",height:18,width:18,backgroundPosition:"0px 0px"}),v.opt.dblclickzoom&&v.bind(v.win,"dblclick",v.doZoom),x.cantouch&&v.opt.gesturezoom&&(v.ongesturezoom=function(e){return e.scale>1.5&&v.doZoomIn(e),e.scale<.8&&v.dozoomout(e),v.cancelevent(e)},v.bind(v.win,"gestureend",v.ongesturezoom))),v.railh=!1,v.opt.horizrailenabled){v.css(t,{"overflow-x":"hidden"}) var s="a(document.createElement("div"))" s.css({position:"absolute",top:0,height:v.opt.cursorwidth,width:"0px","background-color":v.opt.cursorcolor,border:v.opt.cursorborder,"background-clip":"padding-box","-webkit-border-radius":v.opt.cursorborderradius,"-moz-border-radius":v.opt.cursorborderradius,"border-radius":v.opt.cursorborderradius}),s.wborder="parseFloat(s.outerWidth()-s.innerWidth()),v.cursorh=s" w="a(document.createElement("div"))" w.attr("id",v.id+"-hr"),w.addclass("nicescroll-rails"),w.height="Math.max(parseFloat(v.opt.cursorwidth),s.outerHeight()),w.css({height:w.height+"px",zIndex:v.zindex,background:v.opt.background}),w.append(s),w.visibility=!0,w.scrollable=!0,w.align="top"==v.opt.railvalign?0:1,v.railh=w,v.railh.drag=!1}if(v.ispage)d.css({position:"fixed",top:"0px",height:"100%"}),d.css(d.align?{right:"0px"}:{left:"0px"}),v.body.append(d),v.railh&&(w.css({position:"fixed",left:"0px",width:"100%"}),w.css(w.align?{bottom:"0px"}:{top:"0px"}),v.body.append(w))" else{if(v.ishwscroll){"static"="=v.win.css("position")&&v.css(v.win,{position:"relative"})" y="HTML" =="v.win[0].nodeName?v.body:v.win" v.zoom&&(v.zoom.css({position:"absolute",top:1,right:0,"margin-right":d.width+4}),y.append(v.zoom)),d.css({position:"absolute",top:0}),d.css(d.align?{right:0}:{left:0}),y.append(d),w&&(w.css({position:"absolute",left:0,bottom:0}),w.css(w.align?{bottom:0}:{top:0}),y.append(w))}else{v.isfixed="fixed" v.isfixed||(v.viewport="v.getViewport(v.win[0])),v.viewport&&(v.body=v.viewport,0==/fixed|relative|absolute/.test(v.viewport.css("position"))&&v.css(v.viewport,{position:"relative"})),d.css({position:S}),v.zoom&&v.zoom.css({position:S}),v.updateScrollBar(),v.body.append(d),v.zoom&&v.body.append(v.zoom),v.railh&&(w.css({position:S}),v.body.append(w))}x.isios&&v.css(v.win,{"-webkit-tap-highlight-color":"rgba(0,0,0,0)","-webkit-touch-callout":"none"}),x.isie&&v.opt.disableoutline&&v.win.attr("hideFocus","true"),x.iswebkit&&v.opt.disableoutline&&v.win.css({outline:"none"})}if(v.opt.autohidemode===!1?(v.autohidedom=!1,v.rail.css({opacity:v.opt.cursoropacitymax}),v.railh&&v.railh.css({opacity:v.opt.cursoropacitymax})):v.opt.autohidemode===!0||"leave"===v.opt.autohidemode?(v.autohidedom=a().add(v.rail),x.isie8&&(v.autohidedom=v.autohidedom.add(v.cursor)),v.railh&&(v.autohidedom=v.autohidedom.add(v.railh)),v.railh&&x.isie8&&(v.autohidedom=v.autohidedom.add(v.cursorh))):"scroll"==v.opt.autohidemode?(v.autohidedom=a().add(v.rail),v.railh&&(v.autohidedom=v.autohidedom.add(v.railh))):"cursor"==v.opt.autohidemode?(v.autohidedom=a().add(v.cursor),v.railh&&(v.autohidedom=v.autohidedom.add(v.cursorh))):"hidden"==v.opt.autohidemode&&(v.autohidedom=!1,v.hide(),v.locked=!1),x.isie9mobile){v.scrollmom=new" b(v),v.onmangotouch="function(){var" e="v.getScrollTop(),o=v.getScrollLeft()" if(e="=v.scrollmom.lastscrolly&&o==v.scrollmom.lastscrollx)return!0" t="e-v.mangotouch.sy,r=o-v.mangotouch.sx,i=Math.round(Math.sqrt(Math.pow(r,2)+Math.pow(t,2)))" if(0!="i){var" n="0">t?-1:1,s=0>r?-1:1,l=+new Date
...
v._bind(i,s,function(e){if(e.touches){if(e.touches.length<2){var 0="=v.page.maxh||!v.ispage&&"none"==v.win.css("display")||(v.visibility=!0,v.rail.visibility=!0,v.rail.css("display","block")),v},this.showRailHr=function(){return" o="e.touches.length?e.touches[0]:e" o.original="e,t.call(this,o)}}else" if(e.changedtouches){var v._bind(i,o,function(e){return e="e||window.event||!1,e&&e.srcElement&&(e.target=e.srcElement),"pageY"in" e||(e.pagex="e.clientX+document.documentElement.scrollLeft,e.pageY=e.clientY+document.documentElement.scrollTop),t.call(i,e)===!1||r===!1?v.cancelEvent(e):!0})},this._unbind=function(e,o,t,r){e.removeEventListener?e.removeEventListener(o,t,r):e.detachEvent?e.detachEvent("on"+o,t):e["on"+o]=!1},this.unbindAll=function(){for(var" o.q?o.e.unbind(o.n,o.f):v._unbind(o.e,o.n,o.f,o.b)}},this.cancelevent="function(e){var" return e?(e.preventdefault&&e.preventdefault(),e.stoppropagation&&e.stoppropagation(),e.preventmanipulation&&e.preventmanipulation(),e.cancelbubble="!0,e.cancel=!0,e.returnValue=!1,!1):!1},this.stopPropagation=function(e){var" e?e.stoppropagation?e.stoppropagation():(e.cancelbubble&&(e.cancelbubble="!0),!1):!1},this.showRail=function(){return" v.railh?(0="=v.page.maxw||!v.ispage&&"none"==v.win.css("display")||(v.railh.visibility=!0,v.railh.css("display","block")),v):v},this.hideRail=function(){return" v.visibility="!1,v.rail.visibility=!1,v.rail.css("display","none"),v},this.hideRailHr=function(){return" v.railh?(v.railh.visibility="!1,v.railh.css("display","none"),v):v},this.show=function(){return" v.hidden="!1,v.locked=!1,v.showRail().showRailHr()},this.hide=function(){return" v.hidden?v.show():v.hide()},this.remove="function(){v.stop(),v.cursortimeout&&clearTimeout(v.cursortimeout),v.doZoomOut(),v.unbindAll(),x.isie9&&v.win[0].detachEvent("onpropertychange",v.onAttributeChange),v.observer!==!1&&v.observer.disconnect(),v.observerremover!==!1&&v.observerremover.disconnect(),v.events=null,v.cursor&&v.cursor.remove(),v.cursorh&&v.cursorh.remove(),v.rail&&v.rail.remove(),v.railh&&v.railh.remove(),v.zoom&&v.zoom.remove()" for(var o[0].css(o[1],void var t="a.nicescroll" t.each(function(e){if(this&&this.id="==v.id){delete" t[e] t.length--,t.length&&delete t[t.length]}}) r in v)v[r]="null,delete" v[r] v="null},this.scrollstart=function(e){return" this.onscrollstart="e,v},this.scrollend=function(e){return" this.onscrollend="e,v},this.scrollcancel=function(e){return" this.onscrollcancel="e,v},this.zoomin=function(e){return" this.onzoomin="e,v},this.zoomout=function(e){return" this.onzoomout="e,v},this.isScrollable=function(e){var" if("option"="=o.nodeName)return!0" for(;o&&1="=o.nodeType&&!/^BODY|HTML/.test(o.nodeName);){var" if( scroll|auto .test(r))return o.clientheight!="o.scrollHeight" fixed|absolute .test(t.css("position")))return .test(r)&&o.clientheight!="o.scrollHeight)return" if(t.getnicescroll().length>0)return t
...
var o=+new Date,t=!1
if(v.opt.preservenativescrolling&&v.checkarea+600<o&&(v.nativescrollingarea=v.isscrollable(e),t=!0),v.checkarea=o,v.nativescrollingarea)return!0 var r="g(e,!1,t)" return r&&(v.checkarea="0),r}},this.onmousewheelhr=function(e){if(!v.wheelprevented){if(v.locked||!v.railh.scrollable)return!0" if(v.rail.drag)return v.cancelevent(e) o="+new" date,t="!1" v.opt.preservenativescrolling&&v.checkarea+600<o&&(v.nativescrollingarea="v.isScrollable(e),t=!0),v.checkarea=o,v.nativescrollingarea?!0:v.locked?v.cancelEvent(e):g(e,!0,t)}},this.stop=function(){return" v.cancelscroll(),v.scrollmon&&v.scrollmon.stop(),v.cursorfreezed="!1,v.scroll.y=Math.round(v.getScrollTop()*(1/v.scrollratio.y)),v.noticeCursor(),v},this.getTransitionSpeed=function(e){var" t>20?t:0},v.opt.smoothscroll?v.ishwscroll&&x.hastransition&&v.opt.usetransition?(this.prepareTransition=function(e,o){var t=o?e>20?e:0:v.getTransitionSpeed(e),r=t?x.prefixstyle+"transform "+t+"ms ease-out":""
...
t!=o.chky&&o.stop(),o.chky=m,o.nc.setScrollTop(m)}o.timer||(o.nc.hideCursor(),o.doSnapy(p,m))}),o.demulxy</0?v.newscrollx=0:v.newscrollx></0||(v.newscrollx-n)*(e-n)<0)&&v.cancelscroll(),v.newscrolly=o,v.newscrollx=e,v.bouncescroll&&v.rail.visibility||(v.newscrolly<0?v.newscrolly=0:v.newscrolly></v.newscrollx||t></v.newscrolly||t></=1&&(s*=v.newscrollspeed),v.preparetransition(s,!0),v.timerscroll&&v.timerscroll.tm&&clearinterval(v.timerscroll.tm),s></0||(v.newscrollx-i)*(e-i)<0)&&v.cancelscroll(),0==v.opt.bouncescroll&&(0></o&&(v.nativescrollingarea=v.isscrollable(e),t=!0),v.checkarea=o,v.nativescrollingarea)return!0></2){var></0&&(v.scroll.y=0)></0&&(v.scroll.x=0)></.8&&v.dozoomout(e),v.cancelevent(e)},v.bind(v.win,"gestureend",v.ongesturezoom))),v.railh=!1,v.opt.horizrailenabled){v.css(t,{"overflow-x":"hidden"})></=0)return!0></r.length;i++)if(void></o.length;r++)t(e,o[r])}var>